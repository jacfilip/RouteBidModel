...
#40.6945, 40.7163, -74.0019, -73.9738 X=2367m Y=2422
#SetSpawnAndDestPts!(nw, GetNodesBetween(nw,(-700.,-700.), 1000, 2000), GetNodesInRadius(nw,(-700.,-1500.), 500.))
#SetSpawnAndDestPts!(nw, GetNodesInRadius(nw,(700.,-1500.), 500.), GetNodesInRadius(nw,(-1500., 1500.), 500.))

#Bridge1: 1044->1045, 532->1214 , 445->446
SetSpawnAndDestPts!(nw, [345], [847])
...
Random.seed!(0)
sim = Simulation(nw, 30 * 60, maxAgents = 2000, dt = 5.0, initialAgents = 2000, auctions = false)
@time RunSim(sim)
